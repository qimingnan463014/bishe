...
CREATE TABLE `t_salary_record` (
  ...
  `slip_published` TINYINT NOT NULL DEFAULT '0',
  `slip_publish_time` DATETIME DEFAULT NULL,
  `remark` VARCHAR(500) DEFAULT NULL,
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `t_performance` (
  ...
  `perf_bonus_ratio` DECIMAL(10,2) DEFAULT '0.00',
...
CREATE TABLE `t_social_security_config` (
  ...
  `unemployment_rate` DECIMAL(5,4) DEFAULT '0.0030',
...
('2025-01', 1, '10001', '张伟', 1, 95.00, 92.00, 90.00, 5.00, 94.00, '优秀', 1500.00, 101, '张伟', 2),
('2025-01', 2, '10002', '李明', 2, 88.00, 86.00, 90.00, 0.00, 88.00, '优秀', 1500.00, 102, '李明', 2),
('2025-01', 3, '10003', '王强', 3, 92.00, 90.00, 89.00, 0.00, 90.33, '优秀', 1500.00, 103, '王强', 2),
('2025-01', 4, '10004', '赵磊', 4, 85.00, 84.00, 86.00, 0.00, 85.00, '良好', 1200.00, 104, '赵磊', 2),
('2025-01', 5, '10005', '刘洋', 1, 96.00, 94.00, 95.00, 5.00, 96.67, '优秀', 1500.00, 101, '张伟', 2),
('2025-01', 6, '001', '王建国', 1, 82.00, 80.00, 84.00, 0.00, 82.00, '良好', 1200.00, 101, '张伟', 2),
('2025-01', 7, '002', '林晓燕', 1, 92.00, 90.00, 92.00, 0.00, 91.33, '优秀', 1500.00, 101, '张伟', 2),
('2025-01', 8, '003', '陈志远', 2, 87.00, 85.00, 89.00, 0.00, 87.00, '优秀', 1500.00, 102, '李明', 2),
('2025-01', 9, '004', '李雪梅', 2, 84.00, 82.00, 87.00, 0.00, 84.33, '良好', 1200.00, 102, '李明', 2),
('2025-01', 10, '005', '孙浩然', 3, 89.00, 88.00, 90.00, 0.00, 89.00, '优秀', 1500.00, 103, '王强', 2),
('2025-01', 11, '006', '周婷婷', 3, 93.00, 92.00, 94.00, 0.00, 93.00, '优秀', 1500.00, 103, '王强', 2),
('2025-01', 12, '007', '吴俊杰', 4, 86.00, 85.00, 88.00, 0.00, 86.33, '优秀', 1500.00, 104, '赵磊', 2),
('2025-01', 13, '008', '郑美玲', 4, 94.00, 93.00, 95.00, 0.00, 94.00, '优秀', 1500.00, 104, '赵磊', 2),
('2025-01', 14, '009', '苏文博', 1, 88.00, 86.00, 91.00, 0.00, 88.33, '优秀', 1500.00, 101, '张伟', 2),
('2025-01', 15, '010', '林雨萱', 2, 91.00, 89.00, 93.00, 0.00, 91.00, '优秀', 1500.00, 102, '李明', 2);
...
(2, 8, '003', '陈志远', 8, '2025-01', '个税扣除疑问', '我1月份工资6000元，扣除个税150元，请问是如何计算的？', 2, '个税采用累计预扣法计算。应纳税所得额=工资-个人五险一金-起征点。专项附加扣除在当前系统口径中暂按0处理。', 1, '系统管理员', '2025-02-05 11:30:00'),
...
('2025年社保配置', 0.1600, 0.0800, 0.0030, 0.0050, 0.0000, 0.1200, 3000.00, 30000.00, '2025-01-01', 1),
('2024年社保配置', 0.1600, 0.0800, 0.0030, 0.0050, 0.0000, 0.1200, 2800.00, 28000.00, '2024-01-01', 0);
